=== Plugin Name ===
Contributors: valiik (this should be a list of wordpress.org userid's)
Donate link: http://bit.ly/A3SfBN
Tags: responsive, width, theme, development, tool
...
Shows current width of the browser window in real time, to save time on responsive theme development.
...
1. Unzip the archive and put the `Responsiv` folder into your plugins folder (/wp-content/plugins/).
2. Activate the plugin through the 'Plugins' menu in WordPress.

= Usage =

Turn the tag on on the Responsiv settings page and it will display at the top of the site. The width in pixels will update dynamically as you resize the browser window. Once you get to a width that is associated with a device, a little green light will light up next to the device name so you know this is what the site will look like on a screen that size or on that device.
...
1. Responsive Width Tag
2. Displaying the width and device name
