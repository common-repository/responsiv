<?php
/*
Plugin Name: Responsiv
Plugin URI: http://flynewmedia.com/responsiv
...
if ( is_admin() ){
	...
	function rp_create_menu() {
		...
		add_menu_page('Responsiv Settings', 'Responsiv', 'administrator', __FILE__, 'rp_settings_page',plugins_url('/images/rpicon.png', __FILE__));
